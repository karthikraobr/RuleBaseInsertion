        ...
        public void Mainlogic(List<string[]> entireExcel)
        {
            ...
            foreach (string[] excelRow in entireExcel)
            {
                ...
                if (!(string.IsNullOrEmpty(excelRow[0]) && string.IsNullOrWhiteSpace(excelRow[0])))
                {
                    ...
                    sortId = 1;
                    List<string[]> codeSectionArray = GetCodeSection(headerCode);
                    //Adding CodeSections
                    ...
                    foreach (var code in codeSectionArray)
                    {
                        if (!string.IsNullOrEmpty(code[7]))
                        {
                            Guid valueidentifier = databaseOperations.GetCodeSectionIdBasedOnCodeSectionName(code[7]);
                            ...
                            databaseOperations.AddRuleDetail(null, codeSectionId.ToString(), databaseOperations.GetRulePropertyIdfromPropertyCode("CS").ToString(), valueidentifier.ToString(), code[7], 1, 0, 0);
                        }
                        if (!string.IsNullOrEmpty(code[8]) && !string.Equals(code[8], "none"))
                        {
                            Guid valueidentifier = databaseOperations.GetCodeSectionIdBasedOnCodeSectionName(code[8]);

                            databaseOperations.AddRuleDetail(null, codeSectionId.ToString(), databaseOperations.GetRulePropertyIdfromPropertyCode("CS").ToString(), valueidentifier.ToString(), code[8], 0, 0, 0);
                        }
