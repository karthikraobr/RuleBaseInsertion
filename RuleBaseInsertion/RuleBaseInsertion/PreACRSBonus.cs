...
{
    public class PreACRSBonus
    {
        DatabaseOperations databaseOperations = new DatabaseOperations();

        public void MainLogic(List<string[]> excel)
        {
            Guid rulePropertyId = databaseOperations.GetRulePropertyIdfromPropertyCode("PreACRS");
            ...
            {
                Guid preACRSId = databaseOperations.GetPreACRSBonusOnDecription(row[37]);
                Dictionary<string, Guid> availableDeprciationMethods = GetDepreciationMethod(row);
                if (string.Equals(row[0], "P"))
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], autdef.ToString(), 1);
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], bdgdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], busdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], ceqdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], coqdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], cswdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], ffedef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], intdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], ldidef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], lhidef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], lnddef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], ltvdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], mfgdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], ppndef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], rpndef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], rrbdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], suvdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], tlrdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], trhdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], untdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], wrsdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[22], row[23], cstdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
