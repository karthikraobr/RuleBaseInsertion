...
namespace RuleBaseInsertion
{
    public class S179
    {
        ...
        public Dictionary<string, List<S179DTO>> MainLogic(List<string[]> entireExcel)
        {
            foreach (string[] row in entireExcel)
            {
                if (string.Equals(row[2], "P") || string.Equals(row[2],"8"))
                {
                    ...
                    S179DTO.DepreciationMethod = row[23];
                    S179DTO.EstimatedLife = row[24];
                    S179DTO.S179Applicable = row[25];
                    S179DTO.IsQualifiedByDefault = row[26];
                    S179DTO.Zone = row[27];
                    S179DTO.BaseLimit = row[28];
                    S179DTO.ThresholdLimit = row[29];
                    S179DTO.PercentThresholdLimit = row[30];
                ...
                if (string.Equals(row[19], "P") || string.Equals(row[19], "8"))
                {
                    S179DTO S179DTO = new S179DTO();
