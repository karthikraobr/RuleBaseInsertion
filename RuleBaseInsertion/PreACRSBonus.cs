...
namespace RuleBaseInsertion
{
    public class PreACRSBonus
    {
        ...
        public void MainLogic(List<string[]> excel)
        {
            ...
            {
                Guid preACRSId = databaseOperations.GetPreACRSBonusOnDecription(row[36]);
                Dictionary<string, Guid> availableDeprciationMethods = GetDepreciationMethod(row);
                if (string.Equals(row[0], "P"))
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], autdef.ToString(), 1);
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], bdgdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], busdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], ceqdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], coqdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], cswdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], ffedef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], intdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], ldidef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], lhidef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], lnddef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], mfgdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], ppndef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], rpndef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], rrbdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], tlrdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], trhdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], ltvdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], untdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], wrsdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
                ...
                {
                    Guid header = databaseOperations.AddRuleHeader(preACRSId, rulePropertyId, row[21], row[22], cstdef.ToString(), 1);
                    foreach (KeyValuePair<string, Guid> dm in availableDeprciationMethods)
                    {
                        databaseOperations.AddRuleDetail(null, header.ToString(), depreciationMethodRulePropertyId.ToString(), dm.Value.ToString(), dm.Key, 1, 0, 0);
                    }
